...
function MixPoster({ story, gradN = 1, sticker, accent = MIX.amber }) {
  ...
  return (
    <div style={{ position:'relative', aspectRatio:'2/3', width:'100%',
      ...
      {/* Y2K disruptor — sticker burst */}
      {sticker && (
        <div className="mix-burst" style={{ position:'absolute', top: -4, right: -4,
          width: 56, height: 56, background: accent, color: MIX.bg,
          display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center',
          fontFamily: MIX.display, fontSize: 9, fontStyle:'italic', lineHeight: 1,
          letterSpacing:'.04em', transform:'rotate(8deg)', fontWeight: 600 }}>
          <div>{sticker}</div>
        </div>
      )}
      ...
      <div style={{ padding:'14px 18px 14px' }}>
        <div style={{ position:'relative', borderRadius: 8, overflow:'hidden',
          ...
          <div className="mix-burst" style={{ position:'absolute', top: 14, right: 14,
            ...
            display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center',
            fontFamily: MIX.display, fontStyle:'italic', fontSize: 14, lineHeight: 1, fontWeight: 700,
      ...
      <div style={{ position:'relative', margin:'12px 18px 0' }}>
        ...
        <div style={{ position:'relative', borderRadius: 8, overflow:'hidden',
          ...
          <div className="mix-burst" style={{ position:'absolute', top: 14, left: 14,
            width: 64, height: 64, background: MIX.amber, color: MIX.bg,
            display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center',
            fontFamily: MIX.display, fontStyle:'italic', fontSize: 11, lineHeight: 1, fontWeight: 600,
            transform:'rotate(-10deg)' }}>
            <div>vol.1<br/>★ 14 гл</div>
          </div>
    ...
    <div className="mix" style={{ width:'100%', height:'100%', background: MIX.bg,
      ...
      <div style={{ position:'relative', zIndex:3, padding:'40px 36px 30px',
        ...
        <div style={{ position:'relative' }}>
          ...
          <div className="mix-burst" style={{ position:'absolute', top: -16, right: -16, width: 92, height: 92,
            background: MIX.amber, color: MIX.bg, zIndex: 5,
            display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center',
            fontFamily: MIX.display, fontStyle:'italic', fontSize: 18, lineHeight: 1, fontWeight: 700,
            transform:'rotate(8deg)' }}>
            <div>★<br/>хит</div>
          </div>
