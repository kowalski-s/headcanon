...
> Цель ближайшего цикла: MVP для **фокус-группы ≤15 авторов** (редактор + персонажи + граф + momentum), затем AI-соавтор. Спека — [2026-07-15-writer-v2-mvp-design.md](../docs/superpowers/specs/2026-07-15-writer-v2-mvp-design.md). Экраны — `docs/design_handoff_writer_v2`.
...
### Этап A — MVP фокус-группы (заменяет старые W2/W4; дизайн — handoff v2)
...
- **A6-01 [S]** Инвайт-поток фокус-группы (модель `Invite` есть) + first-run: сразу к guided-start-столу (без развилки 3 путей).
- **A6-02 [S]** Empty/loading/error в литературном голосе по всем writer-поверхностям; mobile-проход 320–1280; e2e smoke; re-enable квот (M5-05) для фокус-группы **не** делаем — письмо без лимитов, AI ещё нет.

### Этап B — AI-соавтор (бывший W3, по гибридной модели 2026-06-27 + экран 07)
